                        ...
                        <tbody>
                          <?php foreach($almacen as $rowAlmacen){ ?>
                           <tr>
                               ...
                               <td><a href="index.php/uploader/editaAlmacen?id=<?php echo $rowAlmacen['clave'];?>"><i class="fa fa-pencil-square-o"></i></a></td>
                               <td><a href="index.php/uploader/desactivaAlmacen?id=<?php echo $rowAlmacen['clave'];?>"><i class="fa fa-times-circle "></i></a></td>
                           </tr>
                           <?php } ?>
                        </tbody>
                    </table>
